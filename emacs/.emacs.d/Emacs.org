...
#+end_src
** Table-of-contents
A module to generate a markdown-friendly TOC. No need for it, I'd rather have a toc for ORG files in emacs.
#+begin_src emacs-lisp :tangle no
(use-package toc-org
  :ensure t
  :after org
...
(use-package openwith
  ...
  (setq openwith-associations
   ...
   #+end_src
* Org roam
The best part of Emacs, if used with caution.
...
#+end_src
* LSP
Nope, too much setup time for something simple.
** Eglot
